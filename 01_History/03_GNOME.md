...
El otro programa se llama Outreachy es exclusivo para mujeres a nivel mundial y grupos no representados en USA. Debido al bajo porcentaje de participación de mujeres en el mundo FLOSS se impulsa la intervención de mujeres a través del [Outreachy](https://www.outreachy.org/). Podemos ver algunas participaciones de años anteriores: [2017](https://wiki.gnome.org/Outreachy/2017/MayAugust), [2016](https://wiki.gnome.org/Outreachy/2016/DecemberMarch), [2015](https://wiki.gnome.org/Outreachy/2015/MayAugust), [2014](https://wiki.gnome.org/OutreachProgramForWomen/2014/MayAugust) y [2013](https://wiki.gnome.org/OutreachProgramForWomen/2013/DecemberMarch). Ocurre dos veces al año y puede postular cualquier mujer que no necesariamente esté cursando una carrera en la universidad o instituto.
